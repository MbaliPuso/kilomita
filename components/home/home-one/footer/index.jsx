					...
					<div className="row">
						<div className="col-xl-3 col-md-12">
							<div className="sofax-footer-wrap mr-15">
								...
								<p>
								KiloMITA is built to support drivers, couriers, and fleets with flexible, reliable fuel access tailored to your business needs.
								</p>
						...
						<div className="col-xl-3 col-md-4">
							<div className="sofax-footer-menu ml-100 sofax-footer-active">
								...
								<ul>
									...
									<li>
										<a href="#fuel-partners">Fuel Partners</a>
									</li>
									<li>
						...
						<div className="col-xl-3 col-md-4">
							<div className="sofax-footer-menu sofax-footer-active">
								...
								<div className="download-btn">
									<a className="social-icon" href="https://apps.apple.com/za/app/kilomita/id6738279509" target="_blank">
										<Image src={AppleStore} alt="Apple Store" />
									</a>
									<a className="social-icon" href="https://play.google.com/store/apps/details?id=com.setana.kilomita&hl=en_ZA" target="_blank">
